...
import GlassPlusSvg from "@/assets/icons/glassplus.svg?react";
import GlassMinusSvg from "@/assets/icons/glassminus.svg?react";
...
const ToggleSlider = styled.span<{ isActive: boolean }>`
  ...
  background-color: ${(props) =>
    props.isActive ? colorToken.black : colorToken.beige};
  transition: 0.4s;
  border-radius: 32px;
  display: flex;
  align-items: center;
  ...
  svg {
    ...
    path {
      fill: ${(props) =>
        props.isActive ? colorToken.beige : colorToken.black};
    }
  }
